    ...
    class BaseManipulateEnv(HandEnvClass):
        def __init__(
            ...
            **kwargs,
            ...
            assert self.target_rotation in ["ignore", "fixed", "xyz", "z", "parallel", "fixed_z"]
        ...
        def _goal_distance(self, goal_a, goal_b):
            ...
            if self.target_rotation != "ignore":
                ...
                angle_diff = np.arccos(np.clip(2*quat_diff[...,0]**2-1, -1.0, 1.0))
                d_rot = angle_diff
        ...
        def compute_reward(self, achieved_goal, goal, info):
            if self.reward_type == "sparse":
                ...
                return -(10.0 * d_pos + d_rot) + success*100
...
class MujocoManipulateEnv(get_base_manipulate_env(MujocoHandEnv)):
    ...
    def _reset_sim(self):
        ...
        if self.randomize_initial_rotation:
            if self.target_rotation in ["z", "fixed_z"]:
    ...
    def _sample_goal(self):
        ...
        elif self.target_rotation == "fixed_z":
            target_quat = np.array([ 0.53887393, 0., 0., -0.84238643])
        else:
            raise error.Error(
                f'Unknown target_rotation option "{self.target_rotation}".'
            )
