...
class Robotiq85GripperBase(GripperModel):
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("grippers/robotiq_gripper_85_tactile.xml"), idn=idn)
    ...
    def _important_sensors(self):
        sensor = super()._important_sensors
        sensor["touch_right"] = "touch_right"
        sensor["touch_left"] = "touch_left"
        return sensor


class Robotiq85TactileGripper(Robotiq85GripperBase):
    """
